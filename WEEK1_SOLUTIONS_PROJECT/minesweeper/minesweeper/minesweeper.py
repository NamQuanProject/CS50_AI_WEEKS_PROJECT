...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # 4, 5
        knowledge_hasChanged = True
        while (knowledge_hasChanged):
            knowledge_hasChanged = False
            safes = set()
            mines = set()
            ...
            for set_1 in self.knowledge:
                for set_2 in self.knowledge:
                    ...
                    elif set_1.cells.issubset(set_2.cells):
                        new_set = Sentence(set_2.cells - set_1.cells , set_2.count - set_1.count)
                        if new_set not in self.knowledge:
                            knowledge_hasChanged = True
                            print('New Inferred Knowledge: ', new_set, 'from', set_1, ' and ', set_2)
